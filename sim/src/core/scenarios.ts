...
export const PREDEFINED_SCENARIOS: ScenarioDefinition[] = [
  ...
  },
  {
    ...
    drivers: [
      ...
      { driverId: 'driver-02', vehicleId: 'ROADSCORE_002', origin: 'Galle Face Green', destination: 'Galle Fort', speedProfile: 'normal' },
      { driverId: 'driver-03', vehicleId: 'ROADSCORE_003', origin: 'Kandy (Dalada Maligawa)', destination: 'Colombo Fort', speedProfile: 'normal' },
      { driverId: 'driver-04', vehicleId: 'ROADSCORE_004', origin: 'Colombo Fort', destination: 'Negombo Beach', speedProfile: 'normal' },
      { driverId: 'driver-05', vehicleId: 'ROADSCORE_005', origin: 'Galle Fort', destination: 'Matara City', speedProfile: 'normal' },
      { driverId: 'driver-06', vehicleId: 'ROADSCORE_006', origin: 'Colombo Fort', destination: 'Mount Lavinia', speedProfile: 'normal' },
      { driverId: 'driver-07', vehicleId: 'ROADSCORE_007', origin: 'Battaramulla (Parliament)', destination: 'Colombo Fort', speedProfile: 'normal' },
      { driverId: 'driver-08', vehicleId: 'ROADSCORE_008', origin: 'Colombo Fort', destination: 'Kurunegala Clock Tower', speedProfile: 'normal' },
      { driverId: 'driver-09', vehicleId: 'ROADSCORE_009', origin: 'Galle Fort', destination: 'Colombo Fort', speedProfile: 'normal' },
      { driverId: 'driver-10', vehicleId: 'ROADSCORE_010', origin: 'Negombo Beach', destination: 'Colombo Fort', speedProfile: 'normal' },
    ],
  },
  {
  ...
  },
  {
    ...
    drivers: [
      { driverId: 'driver-01', vehicleId: 'ROADSCORE_001', origin: 'Colombo Fort', destination: 'Kandy (Dalada Maligawa)', speedProfile: 'normal' },
      { driverId: 'driver-02', vehicleId: 'ROADSCORE_002', origin: 'Galle Face Green', destination: 'Galle Fort', speedProfile: 'normal' },
      { driverId: 'driver-03', vehicleId: 'ROADSCORE_003', origin: 'Colombo Fort', destination: 'Kurunegala Clock Tower', speedProfile: 'normal' },
      { driverId: 'driver-04', vehicleId: 'ROADSCORE_004', origin: 'Colombo Fort', destination: 'Negombo Beach', speedProfile: 'normal' },
      { driverId: 'driver-05', vehicleId: 'ROADSCORE_005', origin: 'Galle Fort', destination: 'Matara City', speedProfile: 'normal' },
    ],
  },
